...
<head>
    ...
    <meta name="title" content="Vaat Revolution">
    ...
    <meta property="twitter:title" content="Vaat Revolution">
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6 col-sm-12 bg-light">
            <h1 class="padding-right">
                Join the next micro brewing revolution!
            </h1>
            <p class="padding-right">
                Our VISION is a place of great fresh beers, low- and non-alcoholic alternatives
        ...
        <div class="col-md-6 col-sm-12 bg-dark">
            ...
            <br/>
            <p class="padding-left">Sign up for Crowd Funding news:</p>
            <div id="mc_embed_signup" class="padding-left">
